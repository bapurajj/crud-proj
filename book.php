...
if(isset($_POST['submit'])){
    ...
    $sql= "insert into `books`(name,author,publication,year)
    values('$name','$author','$publication','$year')";
    ...
    <div class="container">
        ...
        <div class="box">
            <form method="post">
                ...
                <br>
                <input type="text" name="puplication" class="shadow p-1 mb-2 bg-body rounded" placeholder="publisher"><br>
